        ...
        <div>
          ...
          <ul className="space-y-2 text-green-100 text-sm">
            <li className="flex items-center gap-2">
              <MapPin size={16} /> Jalandhar, Punjab
            </li>
            <li className="flex items-center gap-2">
              <Phone size={16} /> +917508794201
            </li>
            <li className="flex items-center gap-2">
              <Mail size={16} /> kesavyadav072@gmail.com
            </li>
          </ul>
          {/* 🌐 Social Links */}
          <div className="flex gap-4 mt-4">
            <Link href="https://www.linkedin.com/in/keshavyadav5/" target="_blank">
              <Linkedin className="w-5 h-5 hover:text-white transition" />
            </Link>
            <Link href="https://instagram.com/k_shav09" target="_blank">
              <Instagram className="w-5 h-5 hover:text-white transition" />
            </Link>
            <Link href="https://github.com/keshavyadav5" target="_blank">
